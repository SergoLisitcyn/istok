            ...
            <div class="header__info header-info">
                <div class="header-info__columns">
                    <div class="header-info__item header-info-one">
                        <div class="header-info__socials header-socials">
                            <?php if($settings->telegram) : ?>
                                <a href="https://t.me/<?= $settings->telegram ?>" target="_blank" class="header-socials__icon">
                            ...
                            <?php if($settings->whatsapp) : ?>
                                <a href="https://wa.me/<?= $settings->whatsapp ?>" target="_blank" class="header-socials__icon">
                            ...
                            <?php if($settings->email) : ?>
                                <a href="mailto:<?= $settings->email ?>" class="header-socials__icon">
