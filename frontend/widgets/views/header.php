                ...
                <form class="main-form">
                    <div class="main-form__box">
                        ...
                        <div class="main-form__elem main-form-select">
                            ...
                            <input class="main-form-select__input" type="hidden">
                            <ul class="main-form-select__options">
                                <li class="main-form-select__option">Тема 1</li>
                                <li class="main-form-select__option">Тема 2</li>
                            </ul>
                        </div>
                    </div>
                    <div class="main-form__box">
                        ...
                        <input class="main-form__elem" type="text" id="name" name="name" placeholder="Введите ваше имя" autocomplete="off"></input>
                    </div>
                    <div class="main-form__box">
                        <div class="main-form__icon">
                        ...
                        <input class="main-form__elem" type="tel" id="phone" name="phone" placeholder="Введите ваш телефон" autocomplete="off"></input>
                    </div>
                    <div class="main-form__box">
                        ...
                        <textarea class="main-form__elem" rows="6" name="textarea" placeholder="Ваш вопрос" autocomplete="off"></textarea>
                    </div>
                    <div class="main-form__captcha main-form-captcha">
                        <div class="main-form-captcha__code">
                            <img src="img/capcha.jpg" alt="Capcha">
                        </div>
                        <textarea class="main-form-captcha__text" name="textarea" placeholder="Введите слово на картинке" autocomplete="off"></textarea>
                    </div>
